    ...
    return (
        ...
        >
            <div className="max-w-[1000px] w-full flex flex-col gap-12">
                            ...
                            >
                                ...
                                <div className="relative">
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 text-primary group-hover:from-primary group-hover:to-primary/80 group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-md group-hover:scale-110 shrink-0">
                                            <span className="material-symbols-outlined !text-xl">
                                                dashboard
                                            </span>
                                        </div>
                                        <h3 className="font-bold text-lg text-[#111418] dark:text-white group-hover:text-primary dark:group-hover:text-primary transition-colors duration-300">
                                            {sub.name}
                                        </h3>
                                    </div>
                ...
                {/* Role */}
                <div className="group relative bg-surface-light dark:bg-surface-dark rounded-xl border border-[#e5e7eb] dark:border-[#2a3441] p-6 md:p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div className="flex items-center gap-3 mb-6">
                        <span className="h-6 w-1 bg-primary rounded-full"></span>
                    ...
                    <p className="font-bold text-lg text-[#111418] dark:text-white mb-6">
                        {roleConfig.title}
                    </p>
